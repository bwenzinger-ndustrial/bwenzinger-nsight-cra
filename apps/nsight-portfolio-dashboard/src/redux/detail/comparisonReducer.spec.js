...
describe('nsight-portfolio-dashboard/redux/detail/comparison/reducer', function() {
  it('returns the initial state', function() {
    expect(comparisonReducer(undefined, {})).to.equal(INITIAL_STATE);
  });

  describe(`${actionTypes.PORTFOLIO_DETAIL_COMPARISON_GET_START}`, function() {
    let nextState;
  ...
  describe(`${actionTypes.PORTFOLIO_DETAIL_COMPARISON_GET_SUCCESS}`, function() {
    let nextState;
    let expectedData;
  ...
  describe(`${actionTypes.PORTFOLIO_DETAIL_COMPARISON_GET_FAILURE}`, function() {
    let expectedError;
    let nextState;
  ...
  describe(`${actionTypes.PORTFOLIO_DETAIL_COMPARISON_DATA_RESET}`, function() {
    let nextState;
    let prevState;
