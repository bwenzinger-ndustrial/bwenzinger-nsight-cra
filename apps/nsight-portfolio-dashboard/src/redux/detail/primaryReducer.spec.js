...
describe('nsight-portfolio-dashboard/redux/detail/primary/reducer', function() {
  it('returns the initial state', function() {
    expect(primaryReducer(undefined, {})).to.equal(INITIAL_STATE);
  });

  describe(`${actionTypes.PORTFOLIO_DETAIL_PRIMARY_GET_START}`, function() {
    let nextState;
  ...
  describe(`${actionTypes.PORTFOLIO_DETAIL_PRIMARY_GET_SUCCESS}`, function() {
    let nextState;
    let expectedData;
  ...
  describe(`${actionTypes.PORTFOLIO_DETAIL_PRIMARY_GET_FAILURE}`, function() {
    let expectedError;
    let nextState;
  ...
  describe(`${actionTypes.PORTFOLIO_DETAIL_PRIMARY_DATA_RESET}`, function() {
    let nextState;
    let prevState;
