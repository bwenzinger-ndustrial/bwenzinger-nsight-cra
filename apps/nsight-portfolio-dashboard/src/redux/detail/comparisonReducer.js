...
function comparisonReducer(state = INITIAL_STATE, action) {
  ...
  switch (type) {
    ...
    case actionTypes.PORTFOLIO_DETAIL_COMPARISON_GET_START:
      return {
        ...state,
        isLoading: true
      };

    case actionTypes.PORTFOLIO_DETAIL_COMPARISON_GET_SUCCESS:
      return {
        comparisonDetailByMetric: {
    ...
    case actionTypes.PORTFOLIO_DETAIL_COMPARISON_GET_FAILURE:
      return {
        ...INITIAL_STATE,
        comparisonDates: state.comparisonDates,
        error: payload,
    ...
    case actionTypes.PORTFOLIO_DETAIL_COMPARISON_DATA_RESET:
      return {
        ...INITIAL_STATE,
        comparisonDates: state.comparisonDates,
        error: null,
