...
function primaryReducer(state = INITIAL_STATE, action) {
  ...
  switch (type) {
    case actionTypes.FACILITY_DETAIL_PRIMARY_GET_START:
      return {
        ...state,
        isLoading: true
      };

    case actionTypes.FACILITY_DETAIL_PRIMARY_GET_SUCCESS:
      return {
        primaryDetailByMetric: {
    ...
    case actionTypes.FACILITY_DETAIL_PRIMARY_GET_FAILURE:
      return {
        ...INITIAL_STATE,
        error: payload,
        isLoading: false,
    ...
    case actionTypes.FACILITY_DETAIL_PRIMARY_DATA_RESET:
      return {
        ...INITIAL_STATE,
        error: null,
        isLoading: false,
